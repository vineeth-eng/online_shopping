...
<%@ page import="java.sql.*,databaseconnection.*"%>
 ...
 <div class="spec ">
			...
			<strong>List:</strong> Newest <strong>|</strong> <a href="viewlist2.jsp?id=<%=request.getParameter("id")%>&&name=<%=request.getParameter("name")%>"><font size="" color="#0099ff">Low Cost-High Cost</font></a>
...
<%
	...
	Connection con=databasecon.getconnection();
	 ...
	 sss = "select * from menu3 where menu2='"+id+"' order by menu3 desc ";
